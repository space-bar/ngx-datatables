(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/Subject'), require('rxjs/Observable')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/Subject', 'rxjs/Observable'], factory) :
	(factory((global['ngx-datatables'] = {}),global.ng.core,global.ng.common,global.Rx,global.Rx));
}(this, (function (exports,core,common,Subject,Observable) { 'use strict';
...
DatatablesTemplateDirective.propDecorators = {
    'ngxDatatablesTemplate': [{ type: core.Input },],
};
...
DatatablesColumnComponent.propDecorators = {
    'templates': [{ type: core.ContentChildren, args: [DatatablesTemplateDirective,] },],
...
var DatatablesComponent = (function () {
    ...
    function DatatablesComponent(elementRef, zone, componentFactoryResolver) {
        ...
        this.dataListener = new Subject.Subject();
        this.initListener = Subject.Subject.create();
...
DatatablesComponent.propDecorators = {
    'columns': [{ type: core.ContentChildren, args: [DatatablesColumnComponent,] },],
    'selectionMode': [{ type: core.Input },],
    'tableClass': [{ type: core.Input },],
    'containerClass': [{ type: core.Input },],
    'data': [{ type: core.Input, args: ["data",] },],
    'ajaxOptions': [{ type: core.Input, args: ["ajax",] },],
    'options': [{ type: core.Input, args: ["options",] },],
    'hideSearchInput': [{ type: core.Input, args: ["hideSearchInput",] },],
    'tableElementRef': [{ type: core.ViewChild, args: ["tableElement",] },],
    'datatablesTemplateComponent': [{ type: core.ViewChild, args: [DatatablesTemplateComponent,] },],
    'templateViewContainerRef': [{ type: core.ViewChild, args: ["templateContainer", { read: core.ViewContainerRef },] },],
};
...
DatatablesPortletComponent.propDecorators = {
    'toolsPanelElementRef': [{ type: core.ViewChild, args: ['toolsPanel',] },],
    'actionsPanelElementRef': [{ type: core.ViewChild, args: ['actionsPanel',] },],
    'filterPanelElementRef': [{ type: core.ViewChild, args: ['filterPanel',] },],
    'datatablesComponent': [{ type: core.ContentChild, args: [DatatablesComponent,] },],
    'templates': [{ type: core.ContentChildren, args: [DatatablesTemplateDirective,] },],
    'caption': [{ type: core.Input },],
    'description': [{ type: core.Input },],
    'iconClass': [{ type: core.Input },],
    'filterClass': [{ type: core.Input },],
    'filterTitle': [{ type: core.Input },],
    'filterIconClass': [{ type: core.Input },],
    'fullscreenClass': [{ type: core.Input },],
    'fullscreenTitle': [{ type: core.Input },],
    'fullscreenIconClass': [{ type: core.Input },],
    'showFullscreenIconClass': [{ type: core.Input },],
    'hideFullscreenIconClass': [{ type: core.Input },],
};
...
exports.ɵb = DatatablesColumnComponent;
exports.ɵd = DatatablesPortletComponent;
exports.ɵa = DatatablesTemplateComponent;
exports.ɵc = DatatablesTemplateDirective;
exports.ɵe = DatatablesComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-datatables.umd.js.map
